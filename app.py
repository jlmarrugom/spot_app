...
from methods import get_final_time, get_random_img,compute_text_tokenization, compute_matching_probs
import numpy as np
import datetime
...
if st.checkbox("Start Game!"):
    ...
    while now <= final_hour:
        ...
        match_probs = compute_matching_probs(cropped_img, text_tokens)
